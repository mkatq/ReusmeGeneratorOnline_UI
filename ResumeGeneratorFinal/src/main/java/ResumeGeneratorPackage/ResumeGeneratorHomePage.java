...
JButton select;
    ...
    public ResumeGeneratorHomePage() {
        ...
        LE2.addItemListener(
         ...
         select = new JButton(new ImageIcon("C:\\Users\\mzyon\\Downloads\\icons8-add-image-30.png"));
        ...
        select.addActionListener(
            new AbstractAction() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    FileNameExtensionFilter filter = new FileNameExtensionFilter("All picture", "png", "jpeg", "jpg");
        ...
        Generate.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    try {
                        CV jq = new CV(CIT1.getText(), CIT2.getText(), CIT3.getText(), CIT4.getText(), PTT1.getText(), PTT2.getText(), SMA1.getText(), EDT1.getText(), EDT2.getText(), EDT3.getText(), EDT4.getText(), EDT5.getText(), EDT6.getText(), EDT7.getText(), EDT8.getText(), SKT1.getText(), SKT2.getText(), SKT3.getText(), SKT4.getText(), SKT5.getText(), SKT6.getText(), SKT7.getText(), SKT8.getText(), lg1, lg2, QualficationsA.getText(), exp.getText(), p);
                    } catch (IOException ex) {
                        Logger.getLogger(ResumeGeneratorHomePage.class.getName()).log(Level.SEVERE, null, ex);
                    }
                ...
                public void actionPerformed(ActionEvent e) {
                  ...
                  if(CV.src != null && LogIn.user != null){
                    ...
                    String sql1= String.format("Insert into filepdf(username ,file"+")\n"+"Values ('%s','%s');",LogIn.user,ff);
